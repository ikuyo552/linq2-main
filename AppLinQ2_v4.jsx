...
const FrontWanNewTabContent = ({ tab, form, updTab, clrTab, errors }) => {
  ...
  return (<>
    ...
    <Card>
      ...
      <div style={{ fontSize:12.5, color:C.tealDark, fontWeight:700, marginBottom:8, marginTop:14 }}>💰 月額料金合計（税別）</div>
      <div style={{ padding:"12px 16px", background:C.tealLight, borderRadius:10, border:`1px solid ${C.teal}` }}>
